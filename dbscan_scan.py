...
if __name__ == "__main__":
    ...
    parser.add_argument('--min_points', default=4, type=int, help='minimum points')
    parser.add_argument('--epsilon', default=0.3, type=float, help='Epsilon') # 0.8 for cho and 0.3 for iyer
